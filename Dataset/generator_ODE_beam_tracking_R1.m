...
count = 1;
for i = row_index
    MM_file = ['DeepMIMO_28\MM_dataset\MM_DeepMIMO_dataset_' num2str(i) '_row.mat'];
    load(MM_file);
    ...
    for i = 1 : file_num
        for j = 1 : file_size
            ...
            while flag == 0
                ...
                location = round([initial_x, initial_y] + (speed / 0.2 * [0 : 0.0016 : 1.6]' + ...
                    0.5 * a / 0.2 * ([0 : 0.0016 : 1.6] .^ 2)') * [cos(direction), sin(direction)]);
